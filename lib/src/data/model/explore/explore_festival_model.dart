...
//
//     final exploreFestivalModel = exploreFestivalModelFromJson(jsonString);

import 'dart:convert';

List<ExploreFestivalModel> exploreFestivalModelFromJson(String str) => List<ExploreFestivalModel>.from(json.decode(str).map((x) => ExploreFestivalModel.fromJson(x)));

String exploreFestivalModelToJson(List<ExploreFestivalModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ExploreFestivalModel {
    int? id;
    Images? images;
    String? title;
    String? subtitle;
    ...
    factory ExploreFestivalModel.fromJson(Map<String, dynamic> json) => ExploreFestivalModel(
        id: json["id"],
