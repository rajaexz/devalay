...
//
//     final explorePujaModel = explorePujaModelFromJson(jsonString);

import 'dart:convert';

List<ExplorePujaModel> explorePujaModelFromJson(String str) => List<ExplorePujaModel>.from(json.decode(str).map((x) => ExplorePujaModel.fromJson(x)));

String explorePujaModelToJson(List<ExplorePujaModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ExplorePujaModel {
    int? id;
    Images? images;
    Procedure? purpose;
    Procedure? procedure;
    ...
    factory ExplorePujaModel.fromJson(Map<String, dynamic> json) => ExplorePujaModel(
        id: json["id"],
