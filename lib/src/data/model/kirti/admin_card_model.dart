class AdminOrderResponseModel {
  ...
  final List<dynamic>? requestedPandits;
  ...
  factory AdminOrderResponseModel.fromJson(Map<String, dynamic> json) {
    return AdminOrderResponseModel(
      id: json['id'],
      ...
      requestedPandits: json['requested_pandits'],
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      'id': id,
      'user': user?.toJson(),
      'add_ons': addOns?.map((item) => item.toJson()).toList(),
      'tax': tax,
      ...
      'requested_pandits': requestedPandits,
    };
  }
}
