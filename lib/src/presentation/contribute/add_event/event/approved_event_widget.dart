...
class ApprovedEventWidget extends StatelessWidget {
  const ApprovedEventWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        ContributeEventCubit().sectionIndex = 2;

        return ContributeEventCubit()
          ..fetchContributeEventData(approvedVal: 'true');
      },
      child: BlocBuilder<ContributeEventCubit, ContributeEventState>(
        builder: (context, state) {
          if (state is ContributeEventLoaded) {
            ...
            return state.eventList!.isNotEmpty
                                                ...
                                                builder: (context) {
                                                  return ViewEditBottomsheet(
                                                    ...
                                                    editTap: () {
                                                      Navigator.pop(context);
                                                      AppRouter.push(
                                                          '/addEvent/${eventItem?.id.toString()}/${'EditTemple'}/${0}');
                                                    },
                                                    deleteTap: () async {
                                                      Navigator.pop(context);
                                                      showDialog(
                                                                    ...
                                                                    TextButton(
                                                                      onPressed:
                                                                        ...
                                                                        context
                                                                            ...
                                                                            .fetchContributeEventData(approvedVal: "tru");
                                                                      },
                                                                      child: Text(
                                                                          StringConstant
                                                                              .ok),
