...
class MonitorEventWidget extends StatefulWidget {
  const MonitorEventWidget({super.key});

  @override
  State<MonitorEventWidget> createState() => _MonitorEventWidgetState();
}

class _MonitorEventWidgetState extends State<MonitorEventWidget> {
  @override
  void initState() {
    super.initState();
    // Set section index and apply filter in initState
    context.read<ContributeEventCubit>().sectionIndex = 3;
