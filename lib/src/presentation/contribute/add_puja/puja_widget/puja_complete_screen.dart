...
class PujaCompleteScreen extends StatelessWidget {
  const PujaCompleteScreen({super.key, required this.pujaId, this.calledFrom});
  final String pujaId;
    ...
    return Column(
      ...
      children: [
        ...
        Align(
          ...
          child: Text(
                   StringConstant.yourContributionHasbeen,   style: Theme.of(context)
                  .textTheme
                  .headlineLarge
        ...
        GestureDetector(
            onTap: () {
                  final isReview = calledFrom == 'review';
