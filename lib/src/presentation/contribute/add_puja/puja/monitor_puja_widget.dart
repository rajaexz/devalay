...
class MonitorPujaWidget extends StatefulWidget {
  const MonitorPujaWidget({super.key});

  @override
  State<MonitorPujaWidget> createState() => _MonitorPujaWidgetState();
}

class _MonitorPujaWidgetState extends State<MonitorPujaWidget> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
      ContributePujaCubit()..fetchContributePujaData(value: 'false'),
