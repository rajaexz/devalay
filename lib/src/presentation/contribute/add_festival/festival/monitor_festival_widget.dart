...
class MonitorFestivalWidget extends StatefulWidget {
  const MonitorFestivalWidget({super.key});

  @override
  State<MonitorFestivalWidget> createState() => _MonitorFestivalWidgetState();
}

class _MonitorFestivalWidgetState extends State<MonitorFestivalWidget> {

  @override
  void initState() {
    context.read<ContributeFestivalCubit>().fetchContributeFestivalData(value: 'false');
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
      ContributeFestivalCubit()..fetchContributeFestivalData(value: 'false'),
