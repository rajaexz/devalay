...
class ApprovedFestivalWidget extends StatelessWidget {
  const ApprovedFestivalWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ContributeFestivalCubit()
        ..fetchContributeFestivalData(approvedVal: 'true'),
      child: BlocBuilder<ContributeFestivalCubit, ContributeFestivalState>(
        builder: (context, state) {
          if (state is ContributeFestivalLoaded) {
            ...
            return state.festivalList!.isNotEmpty
                                    ...
                                    children: [
                                      AspectRatio(
                                        ...
                                        child: CustomCacheImage(
                                          imageUrl: festivalItem?.images?.banner
                                                      ?.isNotEmpty ==
                                                  true
                                              ? festivalItem?.images!.banner![0]
                                                      .image ??
                                                  ''
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              // Text(
                                              //   "${festivalItem?.city ?? ''},${festivalItem?.state ?? ''}",
                                              //   style: Theme.of(context)
                                              //       .textTheme
                                              //       .bodySmall,
                                              // ),
