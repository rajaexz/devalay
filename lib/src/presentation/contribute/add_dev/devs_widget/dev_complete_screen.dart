...
class DevCompleteScreen extends StatelessWidget {
  const DevCompleteScreen({super.key, this.devId, this.calledFrom});
    ...
    return Column(
      ...
      children: [
        ...
        Align(
          ...
          child: Text(
            StringConstant.yourContributionHasbeen,
        ...
        GestureDetector(
            onTap: () async {
              if (devId?.isNotEmpty ?? false) {
                if (calledFrom == 'review') {
                  context
                      .read<ContributeDevCubit>()
                      .fetchSingleContributeDevData(devId!, value: 'true');
                } else {
                  context
                      .read<ContributeDevCubit>()
                      .fetchSingleContributeDevData(devId!, value: 'false');
                }
              }
