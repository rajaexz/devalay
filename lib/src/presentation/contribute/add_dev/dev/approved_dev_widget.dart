...
class ApprovedDevWidget extends StatelessWidget {
  const ApprovedDevWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ContributeDevCubit()
      ...
      child: BlocBuilder<ContributeDevCubit, ContributeDevState>(
        ...
        if (state is ContributeDevLoaded) {
          ...
          if (state.model!.isEmpty) {
            return  Center(
              child: Text(StringConstant.noDataMessage),
            );
          }
