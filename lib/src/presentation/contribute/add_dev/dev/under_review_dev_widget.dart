...
class UnderReviewDevWidget extends StatelessWidget {
  const UnderReviewDevWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => ContributeDevCubit()..fetchContributeDevData(
        approvedVal: 'false', rejectVal: 'false', draftVal: 'false'
    ), child: BlocBuilder<ContributeDevCubit,ContributeDevState>(builder: (context, state)
    {
      if (state is ContributeDevLoaded){
        ...
        if(state.model!.isEmpty){
          return const Center(child: Text("No Dev Found"),);
        }
