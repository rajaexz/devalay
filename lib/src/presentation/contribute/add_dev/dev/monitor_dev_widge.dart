...
class MonitorDevWidge extends StatefulWidget {
  const MonitorDevWidge({super.key});

  @override
  State<MonitorDevWidge> createState() => _MonitorDevWidgeState();
}

class _MonitorDevWidgeState extends State<MonitorDevWidge> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => ContributeDevCubit()..fetchContributeDevData(value: 'false'),
