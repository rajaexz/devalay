...
import 'package:devalay_app/src/presentation/dashboard/admin/widget%20/assigned_order_card.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
class AssignedOrderView extends StatefulWidget {
  const AssignedOrderView({super.key});

  @override
  State<AssignedOrderView> createState() => _AssignedOrderViewState();
}

class _AssignedOrderViewState extends State<AssignedOrderView>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!_hasInitialized) {
        context.read<AssignCubit>().fetchAssignedOrderData(loadMoreData: false);
  ...
  void _scrollListener() {
    ...
    if (scrollController.position.pixels >=
      ...
      cubit.fetchAssignedOrderData(loadMoreData: true);
    }
  }
